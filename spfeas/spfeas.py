...
def _options():
    ...
    text_lines = [Fore.GREEN + Style.BRIGHT + 'dmp' + Style.RESET_ALL + '     -- Differential morphological profiles (2 x n scales)',
                  ...
                  Fore.GREEN + Style.BRIGHT + 'hog' + Style.RESET_ALL + '     -- Histogram of Oriented Gradients (5 (mean,variance,std dev,skew,kurtosis) x n scales)',
                  ...
                  Fore.GREEN + Style.BRIGHT + 'lbpm' + Style.RESET_ALL + '    -- Local Binary Patterns moments (5 (mean,variance,std dev,skew,kurtosis) x n scales)',
                  ...
                  Fore.GREEN + Style.BRIGHT + 'orb' + Style.RESET_ALL + '     -- Oriented BRIEF key point pyramid histogram (5 (mean,variance,std dev,skew,kurtosis) x n scales)',
